        ...
        {Object.entries(MODES).map(([key, m]) => {
          ...
          return (
            <div key={key}
              style={{
                ...S.card,
                border: `1px solid ${isActive ? 'rgba(34,197,94,0.6)' : 'var(--border)'}`,
                background: isActive ? 'rgba(34,197,94,0.06)' : 'var(--bg4)',
                marginBottom: 12,
                cursor: 'pointer',
              }}
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 10 }}>
                <div>
                  <div style={{ fontWeight: 800, fontSize: 17, color: 'var(--text1)' }}>{m.label}</div>
                  <div style={{
              ...
              <div style={{ color: 'var(--text2)', fontSize: 13, lineHeight: 1.6 }}>{m.description}</div>
            </div>
          )
        })}
      </div>
