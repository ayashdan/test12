        ...
        {inApp ? (
          <div style={{ background: '#facc1515', border: '1px solid #facc1540', borderRadius: 14, padding: '18px 16px' }}>
            ...
            <div style={{ fontSize: 13, color: 'var(--text3)', lineHeight: 1.6, marginBottom: 14 }}>
              Google sign-in doesn't work inside apps like WhatsApp or Instagram. Tap the menu below and choose <strong style={{ color: 'var(--text1)' }}>"Open in Browser"</strong>.
            </div>
            <div style={{ fontSize: 12, color: 'var(--text4)', background: 'var(--bg3)', borderRadius: 8, padding: '8px 12px' }}>
